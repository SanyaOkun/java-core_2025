...
public class Example10 {
    public static void main(String[] args) {
        ...
        System.out.println("Оставшийся человек: " + peopleArrayList.get(0));
        System.out.println("Время выполнения: " + (endTimeArrayList - startTimeArrayList) + " наносекунд");

        System.out.println("\nLinkedList:");
        System.out.println("Оставшийся человек: " + peopleLinkedList.get(0));
        System.out.println("Время выполнения: " + (endTimeLinkedList - startTimeLinkedList) + " наносекунд");
    }
}
